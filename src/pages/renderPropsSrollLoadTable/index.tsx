...
import RenderPropsScroll from './renderPropsScroll'
...
export default class ScrollLoadTable extends  React.Component<IProps, IState>  {
  ...
  renderTable = (tableHeight: number, dataSource: any) => {
    return <BasicTable tableHeight={tableHeight} dataSource={dataSource} />
  }
